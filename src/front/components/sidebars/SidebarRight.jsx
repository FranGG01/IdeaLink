  ...
  return (
    <aside className="w-64 bg-[#1e293b] p-8 space-y-10 text-white">
          ...
          >
            ...
            <span
              className={`w-2 h-2 rounded-full ${
                index === 0 ? "bg-green-400" : index === 1 ? "bg-yellow-400" : "bg-gray-400"
              }`}
            />
          </div>
        ))}
      ...
      <div className="space-y-4 pt-4 text-sm">
        <div
          className="flex items-center cursor-pointer hover:bg-purple-500/10 px-2 py-1.5 rounded-md"
          onClick={() => console.log("Clicked on Desarrolladores")}
        >
          <div className="flex items-center space-x-3">
        ...
        <div
          className="flex items-center cursor-pointer hover:bg-gray-500/10 px-2 py-1.5 rounded-md"
          onClick={() => console.log("Clicked on Emprendedores")}
        >
          <div className="flex items-center space-x-3">
